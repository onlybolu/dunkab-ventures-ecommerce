...
export default function SignupForm() {
  ...
  return (
    <form onSubmit={handleSignup} className="space-y-4 max-w-md">
      ...
      <p className="text-sm text-slate-600">Get access to faster checkout and order tracking.</p>
      ...
      <div>
        ...
        <p className="mt-1 text-xs text-slate-500">Use 8+ characters with upper, lower, number, and symbol.</p>
      </div>
